    ...
    <header className="sticky top-0 z-20 bg-white px-4 py-4">
      <div className="mx-auto flex max-w-6xl items-center gap-3">
        ...
        <div className="relative hidden shrink-0 md:block">
          ...
          {isMenuOpen && (
            <div className="absolute right-0 mt-3 w-40 rounded-2xl border border-gray-200 bg-white p-2 text-sm text-gray-900 shadow-lg">
              <button
                type="button"
                className="block w-full rounded-xl px-3 py-2 text-left text-gray-900 hover:bg-gray-100"
              >
                Log in
              </button>
              <button
